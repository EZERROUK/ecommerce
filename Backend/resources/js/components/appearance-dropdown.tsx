            ...
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <Button
                        variant="ghost"
                        size="icon"
                        className="size-9 rounded-md border border-slate-200 bg-white shadow-sm hover:bg-slate-100 dark:border-slate-700 dark:bg-white/10 dark:hover:bg-white/20"
                    >
                        <Icon />
                ...
                <DropdownMenuContent
                    align="end"
                    className="min-w-48 rounded-md border border-slate-200 bg-white p-1 shadow-md dark:border-slate-700 dark:bg-slate-900"
                >

...
const breadcrumbs: BreadcrumbItem[] = [{ title: 'Paramètres généraux', href: '/settings/app' }];

export default function AppSettings({ settings, flash: _flash }: { settings: any; flash?: { success?: string } }) {
    ...
    function handleChange(e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) {
        ...
        const value =
            type === 'file' ? ((e.target as HTMLInputElement).files?.[0] ?? null) : (e.target as HTMLInputElement | HTMLTextAreaElement).value;
        if (name in data) {
            ...
            <SettingsLayout>
                ...
                <form onSubmit={submit} className="space-y-6" encType="multipart/form-data">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input value={data.app_name || 'Système de Gestion Centralisée'} readOnly disabled className="opacity-80" />
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input
                                    ...
                                    placeholder="Global Glimpse SARL, B-Panel SAS, …"
                                />
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input id="logo" name="logo" type="file" accept="image/*" onChange={handleChange} ref={logoInput} />
                                <InputError className="mt-2" message={errors.logo} />
                                {(settings.logo_url || settings.logo_path) && (
                                    <img src={settings.logo_url ?? settings.logo_path} alt="Logo actuel" className="mt-2 w-28 rounded border" />
                                )}
                            </div>
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input id="logo_dark" name="logo_dark" type="file" accept="image/*" onChange={handleChange} ref={logoDarkInput} />
                            ...
                            <div className="grid gap-2">
                                ...
                                {settings.favicon_url && (
                                    <img src={settings.favicon_url} alt="Favicon" className="mt-2 h-10 w-10 rounded border bg-white" />
                                )}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div className="grid gap-2">
                                ...
                                <Input id="contact_email" name="contact_email" value={data.contact_email} onChange={handleChange} />
                                <InputError className="mt-2" message={errors.contact_email} />
                            </div>

                            <div className="grid gap-2">
                                <Label htmlFor="contact_phone">Téléphone</Label>
                                <Input id="contact_phone" name="contact_phone" value={data.contact_phone} onChange={handleChange} />
                                <InputError className="mt-2" message={errors.contact_phone} />
                            </div>

                            <div className="grid gap-2 md:col-span-2">
                                <Label htmlFor="contact_address">Adresse</Label>
                                <Input id="contact_address" name="contact_address" value={data.contact_address} onChange={handleChange} />
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div className="grid gap-2">
                                ...
                                <Input id="cgu_url" name="cgu_url" value={data.cgu_url} onChange={handleChange} />
                                <InputError className="mt-2" message={errors.cgu_url} />
                            </div>

                            <div className="grid gap-2">
                                <Label htmlFor="privacy_url">Politique de confidentialité</Label>
                                <Input id="privacy_url" name="privacy_url" value={data.privacy_url} onChange={handleChange} />
                                <InputError className="mt-2" message={errors.privacy_url} />
                            </div>

                            <div className="grid gap-2 md:col-span-2">
                                <Label htmlFor="copyright">Copyright</Label>
                                <Input id="copyright" name="copyright" value={data.copyright} onChange={handleChange} />
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div className="grid gap-2">
                                ...
                                <Input id="twitter" name="twitter" value={data.twitter} onChange={handleChange} />
                            </div>

                            <div className="grid gap-2">
                                <Label htmlFor="facebook">Facebook</Label>
                                <Input id="facebook" name="facebook" value={data.facebook} onChange={handleChange} />
                            </div>

                            <div className="grid gap-2">
                                <Label htmlFor="instagram">Instagram</Label>
                                <Input id="instagram" name="instagram" value={data.instagram} onChange={handleChange} />
                            </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        {recentlySuccessful && <span className="text-sm text-neutral-600">Modifications enregistrées</span>}
                    </div>
                </form>
            </SettingsLayout>
        </AppLayout>

                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input value={settings.app_name ?? 'Système de Gestion Centralisée'} readOnly disabled className="opacity-80" />
                            </div>
                            ...
                            <div className="grid gap-2">
                                ...
                                {settings.logo_path && <img src={settings.logo_path} alt="Logo actuel" className="mt-2 w-28 rounded border" />}
                            </div>
                            ...
                            <div className="grid gap-2">
                                ...
                                {settings.logo_dark_path && (
                                    <img src={settings.logo_dark_path} alt="Logo sombre" className="mt-2 w-28 rounded border bg-neutral-900" />
                                )}
                            </div>

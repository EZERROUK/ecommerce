...
export default function PromotionForm({ initial, onSaved }: { initial?: Partial<Promotion>; onSaved?: () => void }) {
        ...
        <form onSubmit={submit} className="space-y-6">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div>
                    ...
                    <Input type="number" value={data.priority} onChange={(e) => setData('priority', Number(e.target.value))} />
                    <p className="mt-1 text-xs text-slate-500">Plus petit = appliqué en premier</p>
                </div>
                ...
                <div>
                    ...
                    >
                        ...
                        <SelectContent>
                            ...
                            <SelectItem value="bogo" disabled>
                                BOGO (à venir)
                            </SelectItem>
                        </SelectContent>
                    </Select>
                ...
                <div>
                    ...
                    <Select value={data.apply_scope} onValueChange={(v: 'order' | 'category' | 'product') => setData('apply_scope', v)}>
                        <SelectTrigger>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                <div>
                    ...
                    <Select value={data.action_type} onValueChange={(v: 'percent' | 'fixed') => setData('action_type', v)}>
                        <SelectTrigger>
                ...
                <div>
                    <Label>Valeur</Label>
                    <Input type="number" step="0.01" value={data.value ?? 0} onChange={(e) => setData('value', Number(e.target.value))} />
                </div>
                <div>
                    <Label>Code promo (optionnel)</Label>
                    <Input value={data.code ?? ''} onChange={(e) => setData('code', e.target.value)} />
                    <p className="mt-1 text-xs text-slate-500">Si renseigné, la promo ne s’applique que via ce code.</p>
                </div>
            </div>

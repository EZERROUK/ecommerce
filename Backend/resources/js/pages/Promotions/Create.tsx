    ...
    <div className="mb-6 flex flex-col px-6 pt-6 md:flex-row md:items-center md:justify-between">
        <div>
            <h1 className="flex items-center gap-2 text-2xl font-bold text-slate-900 dark:text-white">
                <Tag className="h-6 w-6 text-red-600" /> Créer une promotion
            </h1>
            <p className="text-sm text-slate-600 dark:text-slate-400">Renseignez les informations générales, la validité et la règle de remise.</p>
        </div>
    </div>
);

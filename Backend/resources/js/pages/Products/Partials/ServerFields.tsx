        ...
        <div className="space-y-6">
            <div className="mb-4 flex items-center gap-2">
                <div className="flex h-5 w-5 items-center justify-center rounded-sm bg-red-500">
                    <div className="h-3 w-3 rounded-sm border border-red-500 bg-white"></div>
                </div>
                <h3 className="text-lg font-medium text-slate-900 dark:text-white">Spécifications Serveur</h3>
            </div>
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm backdrop-blur-md dark:border-slate-700 dark:bg-white/5">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            required
                        />
                        {errors.cpu_sockets && <div className="mt-1 text-xs text-red-600 dark:text-red-400">{errors.cpu_sockets}</div>}
                    </div>

                    {/* CPU model */}
                    <div>
                        <label className="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">CPU model</label>
                        <input
                            type="text"
                            ...
                            maxLength={100}
                        />
                        {errors.cpu_model && <div className="mt-1 text-xs text-red-600 dark:text-red-400">{errors.cpu_model}</div>}
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            min={0}
                            max={4096}
                            value={data.installed_memory}
                            onChange={(e) => setData('installed_memory', Number(e.target.value))}
                            className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-slate-900 focus:border-red-500 focus:ring-1 focus:ring-red-500 dark:border-slate-600 dark:bg-slate-800 dark:text-white"
                        />
                        {errors.installed_memory && <div className="mt-1 text-xs text-red-600 dark:text-red-400">{errors.installed_memory}</div>}
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            min={1}
                            max={4096}
                            value={data.max_memory}
                            onChange={(e) => setData('max_memory', Number(e.target.value))}
                            className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-slate-900 focus:border-red-500 focus:ring-1 focus:ring-red-500 dark:border-slate-600 dark:bg-slate-800 dark:text-white"
                            required
                        />
                        {errors.max_memory && <div className="mt-1 text-xs text-red-600 dark:text-red-400">{errors.max_memory}</div>}
                    </div>

                    {/* Memory type */}
                    <div>
                        <label className="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Memory type</label>
                        <select
                    ...
                    <div>
                        ...
                        <input
                            ...
                            min={0}
                            max={24}
                            value={data.drive_bays}
                            onChange={(e) => setData('drive_bays', Number(e.target.value))}
                            className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-slate-900 focus:border-red-500 focus:ring-1 focus:ring-red-500 dark:border-slate-600 dark:bg-slate-800 dark:text-white"
                        />
                        {errors.drive_bays && <div className="mt-1 text-xs text-red-600 dark:text-red-400">{errors.drive_bays}</div>}
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-slate-900 focus:border-red-500 focus:ring-1 focus:ring-red-500 dark:border-slate-600 dark:bg-slate-800 dark:text-white"
                        />
                        {errors.storage_capacity && <div className="mt-1 text-xs text-red-600 dark:text-red-400">{errors.storage_capacity}</div>}
                    </div>
                    ...
                    <div>
                        ...
                        {errors.raid_support && <div className="mt-1 text-xs text-red-600 dark:text-red-400">{errors.raid_support}</div>}
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            min={1}
                            max={8}
                            value={data.ethernet_ports}
                            onChange={(e) => setData('ethernet_ports', Number(e.target.value))}
                            className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-slate-900 focus:border-red-500 focus:ring-1 focus:ring-red-500 dark:border-slate-600 dark:bg-slate-800 dark:text-white"
                        />
                        {errors.ethernet_ports && <div className="mt-1 text-xs text-red-600 dark:text-red-400">{errors.ethernet_ports}</div>}
                    </div>
                    ...
                    <div>
                        ...
                        {errors.ethernet_speed && <div className="mt-1 text-xs text-red-600 dark:text-red-400">{errors.ethernet_speed}</div>}
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            min={1}
                            max={10}
                            value={data.rack_units}
                            onChange={(e) => setData('rack_units', Number(e.target.value))}
                            className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-slate-900 focus:border-red-500 focus:ring-1 focus:ring-red-500 dark:border-slate-600 dark:bg-slate-800 dark:text-white"
                            required
                        />
                        {errors.rack_units && <div className="mt-1 text-xs text-red-600 dark:text-red-400">{errors.rack_units}</div>}
                    </div>

                    {/* Form factor */}
                    <div>
                        <label className="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Form factor</label>
                        <select
                    ...
                    <div className="flex items-center">
                        ...
                        />
                        <label className="ml-2 text-sm text-slate-700 dark:text-slate-300">Fiber Channel présent</label>
                        {errors.fiber_channel && <div className="ml-3 text-xs text-red-600 dark:text-red-400">{errors.fiber_channel}</div>}
                    </div>
                    ...
                    <div className="flex items-center">
                        <input
                            type="checkbox"
                            checked={data.redundant_power_supplies}
                            onChange={(e) => setData('redundant_power_supplies', e.target.checked)}
                            className="h-4 w-4 rounded border-slate-300 text-red-600 focus:ring-red-500 dark:border-slate-600"
                        />
                        <label className="ml-2 text-sm text-slate-700 dark:text-slate-300">Alimentations redondantes</label>
                        {errors.redundant_power_supplies && (
                            <div className="ml-3 text-xs text-red-600 dark:text-red-400">{errors.redundant_power_supplies}</div>
                        )}
                    </div>
                ...
                <div className="mt-6 rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-800 dark:bg-blue-900/20">
                    <div className="text-sm text-blue-700 dark:text-blue-300">
                        <p className="mb-1 font-medium">Conseils pour les serveurs :</p>

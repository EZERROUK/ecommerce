...
const LoginPage: React.FC = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post(
            ...
            {
                onError: (err) => setErrors(err as { email?: string; password?: string }),
        ...
        <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-[#0a0420] via-[#0e0a32] to-[#1B1749]">
            ...
            <div className="relative z-10 flex min-h-screen items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
                <TiltCard className="w-full max-w-md overflow-hidden sm:max-w-xl md:max-w-4xl">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className={`block w-full appearance-none rounded-lg border bg-slate-800 py-3 pr-3 pl-10 shadow-sm transition-colors ${
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                placeholder="••••••••"
                                                className={`block w-full appearance-none rounded-lg border bg-slate-800 py-3 pr-10 pl-10 shadow-sm transition-colors ${
                    ...
                    {/* Pied de carte */}
                    <div className="border-t border-slate-700 bg-white/5 py-4 text-center text-sm text-slate-300 backdrop-blur-md">

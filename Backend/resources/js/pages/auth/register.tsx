                ...
                <div className="flex w-full max-w-md flex-col rounded-xl border border-slate-200 bg-white shadow-xl backdrop-blur-md dark:border-slate-700 dark:bg-white/5">
                    <div className="rounded-t-xl bg-white p-8 dark:bg-transparent">
                        <div className="mb-6 text-center">
                            <h1 className="text-2xl font-bold text-slate-900 md:text-3xl dark:text-white">Créer un compte</h1>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            {/* Confirmation */}
                            <div>
                                <label htmlFor="password_confirmation" className="mb-1 block text-sm text-slate-700 dark:text-slate-300">
                    ...
                    <div className="rounded-b-xl border-t border-slate-200 py-4 text-center text-sm text-slate-500 dark:border-slate-700 dark:bg-white/5 dark:text-slate-300">

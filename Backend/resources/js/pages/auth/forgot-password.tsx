    ...
    return (
        <div className="relative min-h-screen bg-gradient-to-br from-white via-slate-100 to-slate-200 transition-colors duration-500 dark:from-[#0a0420] dark:via-[#0e0a32] dark:to-[#1B1749]">
            ...
            <div className="relative z-10 flex min-h-screen items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
                <div className="flex w-full max-w-md flex-col rounded-xl border border-slate-200 bg-white shadow-xl backdrop-blur-md dark:border-slate-700 dark:bg-white/5">
                    <div className="rounded-t-xl bg-white p-8 dark:bg-transparent">
                        <div className="mb-6 text-center">
                            <h1 className="text-2xl font-bold tracking-tight text-slate-900 md:text-3xl dark:text-white">Mot de passe oublié</h1>
                        ...
                        {status && (
                            <div className="mb-4 rounded-lg bg-green-100 px-4 py-3 text-center text-sm text-green-700 dark:bg-green-600/10 dark:text-green-400">
                                {status}
                            </div>
                        )}
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className={`w-full rounded-lg border bg-white py-3 pr-3 pl-10 dark:bg-slate-800 ${
                                            errors.email
                    ...
                    <div className="rounded-b-xl border-t border-slate-200 bg-white py-4 text-center text-sm text-slate-500 dark:border-slate-700 dark:bg-white/5 dark:text-slate-300">

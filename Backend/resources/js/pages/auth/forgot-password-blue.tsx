    ...
    return (
        <div className="relative min-h-screen bg-gradient-to-br from-[#0a0420] via-[#0e0a32] to-[#1B1749]">
            ...
            <div className="relative z-10 flex min-h-screen items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
                <div className="flex w-full max-w-md flex-col rounded-xl border border-slate-700 bg-white/5 shadow-xl backdrop-blur-md">
                    <div className="p-8">
                        <div className="mb-6 text-center">
                            <h1 className="text-2xl font-bold tracking-tight text-white md:text-3xl">Mot de passe oublié</h1>
                            <p className="mt-2 text-sm text-slate-400">Entrez votre email pour recevoir un lien de réinitialisation</p>
                        </div>

                        {status && <div className="mb-4 rounded-lg bg-green-600/10 px-4 py-3 text-center text-sm text-green-400">{status}</div>}
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className={`w-full rounded-lg border bg-slate-800 py-3 pr-3 pl-10 ${
                    ...
                    <div className="border-t border-slate-700 bg-white/5 py-4 text-center text-sm text-slate-300">

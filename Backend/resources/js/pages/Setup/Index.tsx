...
const SetupIndex: React.FC<SettingsProps> = ({ settings }) => {
    ...
    const expectedLengths = [...country.lengths] as number[];
    const maxLen = Math.max(...expectedLengths);
    const fullInternational = `${country.dial}${nationalNumber}`;
    const isContactPhoneValid = !!nationalNumber && expectedLengths.includes(nationalNumber.length);
    ...
    const progress = useMemo(() => {
        const items = [
            ...
            { key: 'contact_phone', done: isContactPhoneValid },
    ...
    return (
        <div className="relative min-h-screen bg-gradient-to-br from-white via-slate-100 to-slate-200 transition-colors duration-500 dark:from-[#0a0420] dark:via-[#0e0a32] dark:to-[#1B1749]">
            ...
            {/* HERO */}
            <header className="relative z-10 px-4 pt-16 text-center sm:pt-20">
                <div className="mx-auto max-w-3xl">
                    <div className="inline-flex items-center gap-2 rounded-full border border-white/30 bg-white/60 px-4 py-1.5 text-xs font-medium text-slate-700 shadow-sm backdrop-blur dark:border-white/10 dark:bg-white/10 dark:text-white">
                        ...
                        Assistant de configuration — Système de Gestion Centralisée
                    </div>
                    ...
                    <p className="mt-3 text-slate-600 dark:text-slate-300">
                        Renseignez la <span className="font-semibold">raison sociale</span>, votre logo et les informations clés. Vous pourrez tout
                        modifier plus tard dans
            ...
            <main className="relative z-10 px-4 pt-8 pb-16">
                <div className="mx-auto max-w-3xl rounded-2xl bg-white/70 shadow-xl ring-1 ring-slate-200 backdrop-blur dark:bg-white/10 dark:ring-white/10">
                    ...
                    <form onSubmit={submit} className="space-y-10 px-6 pt-6 pb-8 sm:px-8 sm:pt-8">
                        {/* Identité */}
                        <section>
                            ...
                            <div className="mt-4 grid grid-cols-1 gap-4">
                                <div>
                                    ...
                                    <div className="relative">
                                        <Building2 className="absolute top-1/2 left-3 h-5 w-5 -translate-y-1/2 text-slate-400" />
                                        <input
                                            id="company_name"
                                            name="company_name"
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <Type className="absolute top-1/2 left-3 h-5 w-5 -translate-y-1/2 text-slate-400" />
                                        <input
                                            id="app_slogan"
                                            name="app_slogan"
                        ...
                        <section>
                            ...
                            <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">Téléversez votre logo clair, sombre et un favicon.</p>
                            ...
                            <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-3">
                                ...
                                <div className="rounded-lg border border-slate-200 bg-white/70 p-4 dark:border-white/10 dark:bg-white/5">
                                    ...
                                    <input
                                        ...
                                        onChange={(e: any) => {
                                            handleChange(e);
                                            setFilePreview(e.target.files?.[0] ?? null, setLogoPreview);
                                        }}
                                        accept="image/*"
                                        className="hidden"
                                    />
                                ...
                                <div className="rounded-lg border border-slate-200 bg-white/70 p-4 dark:border-white/10 dark:bg-white/5">
                                    ...
                                    <input
                                        ...
                                        onChange={(e: any) => {
                                            handleChange(e);
                                            setFilePreview(e.target.files?.[0] ?? null, setLogoDarkPreview);
                                        }}
                                        accept="image/*"
                                        className="hidden"
                                    />
                                ...
                                <div className="rounded-lg border border-slate-200 bg-white/70 p-4 dark:border-white/10 dark:bg-white/5">
                                    ...
                                    <input
                                        ...
                                        onChange={(e: any) => {
                                            handleChange(e);
                                            setFilePreview(e.target.files?.[0] ?? null, setFaviconPreview);
                                        }}
                                        ...
                                        <div className="relative">
                                            <div className="relative flex items-center rounded-lg border border-slate-300 bg-white focus-within:ring-1 focus-within:ring-red-500 dark:border-slate-700 dark:bg-slate-800">
                                                <button
                                                    ...
                                                    className="flex items-center gap-2 border-r border-slate-200 px-3 py-2 text-sm text-slate-700 dark:border-slate-700 dark:text-slate-200"
                        ...
                        <section>
                            ...
                            <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                                <div>
                                    ...
                                    <div className="relative">
                                        <Twitter className="absolute top-1/2 left-3 h-5 w-5 -translate-y-1/2 text-slate-400" />
                                        <input
                                            id="twitter"
                                            name="twitter"
                                            value={data.twitter}
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <Facebook className="absolute top-1/2 left-3 h-5 w-5 -translate-y-1/2 text-slate-400" />
                                        <input
                                            id="facebook"
                                            name="facebook"
                                            value={data.facebook}
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <Instagram className="absolute top-1/2 left-3 h-5 w-5 -translate-y-1/2 text-slate-400" />
                                        <input
                                            id="instagram"
                                            name="instagram"
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <Linkedin className="absolute top-1/2 left-3 h-5 w-5 -translate-y-1/2 text-slate-400" />
                                        <input
                                            id="linkedin"
                                            name="linkedin"
                                            value={data.linkedin}
                            ...
                            <div className="mt-4 grid grid-cols-1 gap-4">
                                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    <div>
                                        ...
                                        <div className="relative">
                                            <LinkIcon className="absolute top-1/2 left-3 h-5 w-5 -translate-y-1/2 text-slate-400" />
                                            <input
                                                id="cgu_url"
                                                name="cgu_url"
                                                value={data.cgu_url}
                ...
                <div className="mx-auto mt-6 max-w-3xl text-center text-xs text-slate-500 dark:text-slate-400">
                    ...
                    <button
                        ...
                        className="text-slate-700 underline decoration-dotted hover:text-red-500 dark:text-slate-200"
                    >
            ...
            {showTerms && (
                <div className="fixed inset-0 z-50">
                    ...
                    <div className="absolute top-1/2 left-1/2 w-[95vw] max-w-4xl -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-white/10 bg-white/90 shadow-2xl backdrop-blur dark:bg-slate-900/90">
                        <div className="flex items-center justify-between gap-3 border-b border-slate-200/60 px-4 py-3 dark:border-white/10">
                            <div className="text-sm font-semibold text-slate-800 dark:text-slate-100">Conditions d’utilisation</div>
